...
// Only output the PaymentNetwork Transaction information if it was recorded for this order!
if (isset($form_transaction_info->fields)) {
	...
	$output .= $form_transaction_info->fields['paymentnetwork_transactionUnique'] . "\n";
	$output .= '</td></tr>' . "\n";
	$output .= '<tr><td class="main">' . "\n";
	$output .= "xref\n";
	$output .= '</td><td class="main">' . "\n";
	...
	if (MODULE_PAYMENT_PAYMENTNETWORK_CAPTURE_TYPE == 'Direct') {
		...
		// confirm checkbox
		$output .= MODULE_PAYMENT_PAYMENTNETWORK_REFUND_CONFIRM_CHECK . zen_draw_checkbox_field('refconfirm', '', false) . '<br />';
		//comment field
		$output .= '<br />' . MODULE_PAYMENT_PAYMENTNETWORK_REFUND_TEXT_COMMENTS . '<br />' . zen_draw_textarea_field('refnote', 'soft', '50', '3', MODULE_PAYMENT_PAYMENTNETWORK_REFUND_DEFAULT_MESSAGE);
		//message text
		$output .= '<br />' . MODULE_PAYMENT_PAYMENTNETWORK_REFUND_SUFFIX;
		...
		$output .= MODULE_PAYMENT_PAYMENTNETWORK_CAPTURE . '<br />';
		$output .= '<br />' . MODULE_PAYMENT_PAYMENTNETWORK_CAPTURE_AMOUNT_TEXT . ' ' . zen_draw_input_field('captamt', '', 'length="8" placeholder="Enter Amount"') . '<br />';
		// Confirm checkbox
		$output .= MODULE_PAYMENT_PAYMENTNETWORK_CAPTURE_CONFIRM_CHECK . zen_draw_checkbox_field('captconfirm', '', false) . '<br />';
		// Comment field
